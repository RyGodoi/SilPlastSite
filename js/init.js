  ...
  $("#gerar-link").on("click", function () {
    if (arraymedidas.length != 0) {
      ...
      for (let index = 0; index < arraymedidas.length; index++) {
        arraywhatsapp.push(arraymedidas[index].replace(/ /g, "%20") + "%0A%0A");
      }
      ...
      $(".links-gerados").append(
        "<a href='https://api.whatsapp.com/send?phone=5511953760769&text=Ol%C3%A1%20Silplast,%20esses%20s%C3%A3o%20meus%20pedidos:%0A%0A" + arraymedidas + "%0A%0Amuito%20obrigado%20pela%20aten%C3%A7%C3%A3o,%20aguardo%20retorno.'>Click aqui para encaminhar o pedido</a>");
